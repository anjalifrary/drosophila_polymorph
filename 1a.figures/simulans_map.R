...
##### A) Map
#### samples file
samps <- fread("/Users/alanbergland/Documents/GitHub/DESTv2-SNAPE/analysis/simulans/metadata/simulans_pooled.meta.use.csv")
...
a <- ggplot() +
  ...
  geom_point(
    ...
    aes(x=long,
        y=lat,
        fill = set, color = set), size = 2.5, shape = 21
  )
a
