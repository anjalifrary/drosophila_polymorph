...
### FILTER CANDIDATES/BG FOR MAF FILTER - save gowinda inputs
...
bg_SpeciesSpecific <- merge(bg_SpeciesSpecific, rbind(mel_nlp[,.(chr,pos,global_af,poly_af)], sim_nlp[,.(chr,pos,global_af,poly_af)]),
